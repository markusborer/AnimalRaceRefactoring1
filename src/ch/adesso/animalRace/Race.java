		...
		switch (animal.getAnimalType()) {
			case ELEFANT:
				if (positions.get(index) < 100)
					switch (weather) {
					case SUNNY:
						positions.set(index, positions.get(index) + 4);
						break;
					case RAINY:
						positions.set(index, positions.get(index) + 1);
						break;
					case STORMY:
						positions.set(index, positions.get(index) + 2);
						break;
					}
				break;
			case HEDGEHOG:
			...
			case TIGER:
				if (positions.get(index) < 100)
					switch (weather) {
					case SUNNY:
						positions.set(index, positions.get(index) + 8);
						break;
					case RAINY:
						positions.set(index, positions.get(index) + 6);
						break;
					case STORMY:
						positions.set(index, positions.get(index) + 4);
						break;
